...
this document to them: **54 files** touch process-wide state —
**28** use the shared guard, **25** restore locally,
...
than passes where there is no display; and #348 added three to the

...
**40 files** touch process-wide state: 19 protected by the shared SwingSession guard, 20 restoring locally - the JUnit-fixture preference shape the consolidation (#224) deliberately kept - 0 unprotected, and the guard itself classified as what it is.
...
| renderer-drawn | byte-reproducible per machine; production ink, no widgets | 192 |

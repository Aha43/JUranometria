...
- reads of live chart state (currentScene, pageOffsetY, navigation.state): **343** across the suite
- explicit event-thread hand-offs (invokeAndWait): **548**
...
| renderer-drawn | byte-reproducible per machine; production ink, no widgets | 236 |

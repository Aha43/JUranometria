...
**29 display-dependent files.** 17 state a focused-window or focus-owner premise, 21 state a reachability premise, and 18 use a back-door action (doClick or postActionEvent) somewhere - each either a menu convention or a debt the discipline issue #243 owns.
...
- explicit event-thread hand-offs (invokeAndWait): **580**

## Generated evidence, classified

| class | the contract | files |
|---|---|---|
| deterministic-report | regenerates byte-for-byte on the same tree | 16 |

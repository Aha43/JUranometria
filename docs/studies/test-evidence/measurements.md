...
**16 evidence executables** touch process-wide state; 15 carry an unpaired touch.
...
- explicit event-thread hand-offs (invokeAndWait): **727**

## Generated evidence, classified

| class | the contract | files |
|---|---|---|
| deterministic-report | regenerates byte-for-byte on the same tree | 60 |
...
| renderer-drawn | byte-reproducible per machine; production ink, no widgets | 341 |

...
**62 files** touch process-wide state: 33 protected by the shared SwingSession guard, 28 restoring locally - the JUnit-fixture preference shape the consolidation (#224) deliberately kept - 0 unprotected, and the guard itself classified as what it is.
...
- explicit event-thread hand-offs (invokeAndWait): **761**

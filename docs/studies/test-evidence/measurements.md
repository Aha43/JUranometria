...
**51 files** touch process-wide state: 28 protected by the shared SwingSession guard, 22 restoring locally - the JUnit-fixture preference shape the consolidation (#224) deliberately kept - 0 unprotected, and the guard itself classified as what it is.
...
| renderer-drawn | byte-reproducible per machine; production ink, no widgets | 299 |

...
- reads of live chart state (currentScene, pageOffsetY, navigation.state): **350** across the suite
- explicit event-thread hand-offs (invokeAndWait): **552**

## Generated evidence, classified

| class | the contract | files |
|---|---|---|
| deterministic-report | regenerates byte-for-byte on the same tree | 15 |

...
| juranometria/app/AtlasChromeCompositionTest.java | preferences | protected-locally |
| juranometria/app/ChartFurnitureTest.java | preferences | protected-locally |
| juranometria/app/ChartKeyboardJourneyTest.java | look-and-feel, preferences | protected-shared |
| juranometria/app/ChartKeyboardLifecycleTest.java | look-and-feel | protected-shared |
| juranometria/app/ChartKeyboardMatrixTest.java | look-and-feel, preferences | protected-shared |
...
| juranometria/app/ChartOptionsLanguageTest.java | preferences | protected-locally |
| juranometria/app/ChartOptionsLayoutTest.java | preferences | protected-locally |
| juranometria/app/ChartOptionsSizeDeclarationTest.java | preferences | protected-locally |
...
| juranometria/app/ExportSheetDialogTest.java | look-and-feel | protected-shared |
| juranometria/app/InspectorModeChooserTest.java | default-font | protected-shared |
| juranometria/app/InterfaceLanguageMigrationTest.java | preferences | protected-locally |
| juranometria/app/LegendContrastTest.java | look-and-feel | protected-shared |
| juranometria/app/NorwegianSkyJourneyTest.java | look-and-feel, preferences | protected-shared |
...
| juranometria/app/ReaderSkyLanguageTest.java | preferences | protected-locally |
| juranometria/app/SettingsLanguageTest.java | preferences | protected-locally |
| juranometria/app/SprintThirtyOneJourneyTest.java | look-and-feel | protected-shared |
| juranometria/app/SprintThirtyTwoJourneyTest.java | look-and-feel | protected-shared |
| juranometria/app/StartupJourneyTest.java | locale | protected-shared |
...
| juranometria/ui/AtlasToolbarLanguageTest.java | look-and-feel | protected-shared |
...
| juranometria/ui/ChartKeyboardWiringTest.java | look-and-feel, repaint-manager, preferences | protected-shared |
| juranometria/ui/ChartOptionsJourneyTest.java | preferences | protected-locally |
| juranometria/ui/ControlExplanationJourneyTest.java | look-and-feel | protected-shared |
...
| juranometria/ui/GlobeDefaultsDoNotLeakTest.java | preferences | protected-locally |
...
| juranometria/ui/SprintTwentyFourJourneyTest.java | preferences | protected-locally |
| juranometria/ui/SprintTwentyThreeJourneyTest.java | preferences | protected-locally |
| juranometria/ui/WorkingSelectionSurfacesJourneyTest.java | look-and-feel, default-font, preferences | protected-shared |
| juranometria/ui/ecliptic/EclipticMenuSurfaceTest.java | look-and-feel, default-font | protected-shared |
| juranometria/ui/language/SkyLanguageSessionTest.java | preferences | protected-locally |
| juranometria/ui/language/SkyLanguageStoreTest.java | preferences | protected-locally |
| juranometria/ui/language/SwingTextTest.java | look-and-feel, locale | protected-shared |
| juranometria/ui/placeandtime/FrozenNoteTest.java | look-and-feel, preferences | protected-shared |
...
| juranometria/ui/placeandtime/PlaceAndTimeSizeDeclarationTest.java | preferences | protected-locally |

**66 files** touch process-wide state: 33 protected by the shared SwingSession guard, 32 restoring locally - the JUnit-fixture preference shape the consolidation (#224) deliberately kept - 0 unprotected, and the guard itself classified as what it is.
...
| juranometria/ui/ControlExplanationJourneyTest.java | none | none |
...
| juranometria/ui/SearchFieldLanguageTest.java | none | none |
...
| juranometria/ui/language/SwingTextTest.java | none | none |
...
- juranometria/app/ChartKeyboardJourneyTest.java: menu-shortcut-mask
...
- reads of live chart state (currentScene, pageOffsetY, navigation.state): **442** across the suite
- explicit event-thread hand-offs (invokeAndWait): **804**

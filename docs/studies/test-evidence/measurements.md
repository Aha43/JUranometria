...
| juranometria/ui/WorkingSelectionSurfacesJourneyTest.java | look-and-feel, default-font | protected-shared |
...
**42 files** touch process-wide state: 21 protected by the shared SwingSession guard, 20 restoring locally - the JUnit-fixture preference shape the consolidation (#224) deliberately kept - 0 unprotected, and the guard itself classified as what it is.

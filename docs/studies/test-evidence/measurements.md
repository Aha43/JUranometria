...
**56 files** touch process-wide state: 29 protected by the shared SwingSession guard, 26 restoring locally - the JUnit-fixture preference shape the consolidation (#224) deliberately kept - 0 unprotected, and the guard itself classified as what it is.
...
- explicit event-thread hand-offs (invokeAndWait): **700**

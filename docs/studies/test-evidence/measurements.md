...
**17 evidence executables** touch process-wide state; 16 carry an unpaired touch.
...
|---|---|---|
| deterministic-report | regenerates byte-for-byte on the same tree | 61 |
...
| renderer-drawn | byte-reproducible per machine; production ink, no widgets | 349 |

...
|---|---|---|---|---|---|
| Toolbar | JButton | (icon only) | Zoom in (⌃=) | Shows a narrower field, with fainter stars on it | dynamic |
| Toolbar | JButton | (icon only) | Zoom out (⌃-) | Shows a wider field, with fewer stars on it | dynamic |
...
| Toolbar | JToggleButton | (icon only) | Show the Inspector: what the selected mark is (⌃I) | Hidden; press to open the panel that names what you have chosen and what is on this page | dynamic |
...
| Inspector | JButton | (icon only) | Close Inspector (⌃I) | Hides this pane. The chart keeps its place, its target and your selection, and widens t... | hovered |
